...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        console.log("MuskyFit: Initializing System...");
        ...
        // Fallback to onboarding if profile can't be fetched
        setNeedsOnboarding(true);
      } finally {
        // Guaranteed minimum splash time for brand impact and system stability
