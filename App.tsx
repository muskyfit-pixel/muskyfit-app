...
import NutritionScreen from './components/NutritionScreen.tsx';
...
import { FoodItem, WorkoutData, FoodLog, WorkoutLogged, Client, ComplianceStats } from './types.ts';
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // Guaranteed minimum splash time for brand impact
